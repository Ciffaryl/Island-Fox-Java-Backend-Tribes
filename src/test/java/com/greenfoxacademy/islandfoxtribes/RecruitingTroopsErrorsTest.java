...
public class RecruitingTroopsErrorsTest extends TestSetup {
    ...
    @Test
    public void createTroopsMissingBarracksTest() throws Exception {
        Mockito.when(playerServiceImpl.validation(2L)).thenReturn(true);
        mockMvc.perform(MockMvcRequestBuilders.post("/kingdoms/2/troops").
                ...
                .andExpect(content().json("{\n" +
                        "    \"error\": \"You don't have barracks yet!\"\n" +
                        "}"));
    }

    @Test
    public void createTroopsBarracksIsBuildingTest() throws Exception {
        this.building2.setCreating(true);
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/kingdoms/1/troops").
                ...
                .andExpect(status().isForbidden())
                .andExpect(content().json("{\n" +
                        "    \"error\": \"Your barracks are already making new troops!\"\n" +
                        "}"));
    }
}
